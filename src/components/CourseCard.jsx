            ...
            <div className="flex justify-between items-start mb-2">
                ...
                <div className="text-right relative">
                    ...
                    {showTooltip && (
                        <div
                            ref={tooltipRef}
                            className={`absolute right-0 w-72 bg-gray-900 text-white text-xs rounded-lg shadow-xl p-4 z-10 ${tooltipPosition === 'bottom' ? 'top-full mt-2' : 'bottom-full mb-2'
                                }`}>
                            ...
                            <div className="space-y-1 border-t border-gray-700 pt-2">
                                ...
                                <div className="flex justify-between">
                                    <span className="text-gray-400">Median GPA:</span>
                                    <span className={`font-medium ${gpaColor(course.medianGpa).replace('text-', 'text-')}`}>
                                        {course.medianGpa}
                                    </span>
                                </div>
                            </div>
